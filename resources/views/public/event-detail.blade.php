                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 border-t border-gray-100">
                            ...
                            <div class="text-center col-span-2 md:col-span-1">
                                <div class="text-2xl font-bold text-emerald-600">Rp {{ number_format((float) $event->price, 0, ',', '.') }}</div>
                                <div class="text-sm text-gray-600">Biaya tiket</div>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    @else
                        ...
                        <div class="text-center">
                            <p class="text-xs text-gray-500">
                                ...
                                @if($event->isPaid())
                                    Biaya: Rp {{ number_format((float) $event->price, 0, ',', '.') }} • Pembayaran online setelah daftar
                                @else
